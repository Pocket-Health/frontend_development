...
class UnAuthMedicalCardScreen extends StatefulWidget {
  const UnAuthMedicalCardScreen({super.key});

  @override
  State<UnAuthMedicalCardScreen> createState() => _UnAuthMedicalCardScreenState();
}
